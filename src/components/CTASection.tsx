    ...
    >
      <div ref={contentRef} className="max-w-3xl w-full text-center p-8 md:p-12 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <a href="#" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[#1877F2] hover:bg-white/20 transition-all duration-200" aria-label="Facebook">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
          </a>
          <a href="#" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[#E4405F] hover:bg-white/20 transition-all duration-200" aria-label="Instagram">
          ...
          <a href="#" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[#25D366] hover:bg-white/20 transition-all duration-200" aria-label="WhatsApp">
          ...
          <a href="#" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[#FF0000] hover:bg-white/20 transition-all duration-200" aria-label="YouTube">
